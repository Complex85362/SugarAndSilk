...
<head>
    ...
    <%-- Cache buster appended (?v=2.5) to instantly force browser execution of the new CSS layout --%>
            ...
            <div class="review-form-container">
                ...
                <form action="${pageContext.request.contextPath}/submitReview" method="post" class="review-form">
                    ...
                    <div class="message-group">
                        <textarea name="comment" placeholder="Share your thoughts about this product..." rows="5" required></textarea>
                    </div>
